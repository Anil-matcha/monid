...
| `firecrawl` | scrape, map, search, crawl (async), batch/scrape (async), agent (async)                                                                                                                                             | `Bearer`    | credits (1 per page or map call, 2 per 10 search results; per-page surcharges for LLM formats, PDF pages, ZDR and x.com routing) |
