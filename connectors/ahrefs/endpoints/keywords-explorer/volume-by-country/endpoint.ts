...
export default defineEndpoint({
    meta: {
        ...
        summary: "Split a keyword's search volume across countries.",
        description:
            "Split a keyword's global search volume by country, one row per " +
    ...
    usage: {
         ...
         *  Rate card: 11 units/row = all returned fields, 1 × 1 + volume 10 —
         *  the field costs on
