...
export default defineEndpoint({
    meta: {
        ...
        summary: "Break down a target's internal links by anchor text.",
        description:
            "Aggregate the target's internal links by anchor text, one row " +
            "per distinct anchor. Returns the anchor, the number of " +
            "internal links using it, the number of pages linked, and the " +
    ...
    input: {
        ...
        toRequest: ({ data }) => ({
            ...
            queryParams: {
                ...
                select: "anchor,links_from_target,linked_pages,first_seen",
            },
        }),
    },
    usage: {
